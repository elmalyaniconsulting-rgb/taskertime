...
const ACTIVITES = [
  { value: 'formateur', label: 'Formateur / Consultant' },
  { value: 'coach', label: 'Coach / Thérapeute' },
  { value: 'avocat', label: 'Avocat / Juriste' },
  { value: 'comptable', label: 'Comptable / Expert-comptable' },
  { value: 'architecte', label: 'Architecte / Designer' },
  { value: 'photographe', label: 'Photographe / Vidéaste' },
  { value: 'artisan', label: 'Artisan (plombier, électricien...)' },
  { value: 'dev', label: 'Développeur / Freelance tech' },
  { value: 'sante', label: 'Professionnel de santé' },
  { value: 'beaute', label: 'Esthéticien(ne) / Coiffeur(se)' },
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => handleChange('activite', value)}
            >
              <SelectTrigger>
